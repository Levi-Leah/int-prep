...
Traditional metrics systems struggle with high cardinality because they store time series for every unique combination of label values. If you have 10 labels each with 100 possible values, you potentially have 100{caret}10 time series, which becomes computationally and economically infeasible.
